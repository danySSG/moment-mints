...
//   7. НОВЫЕ КОЛЛИЗИИ (16.07, fix-7): "spray FANNING" → веер в руках игрока (3/3);
//      "arms swept back LIKE WINGS" → ангельские крылья (3/3). Сравнения и
//      метафоры в промпте материализуются буквально. Только прямые слова.
//      И "overhead BICYCLE kick" → буквальный велосипед в кадре (поймал оператор
//      на живом сайте, 2 карточки). Футбольный жаргон - тоже коллизия.
//   8. furry/animal живут в BASE_NEGATIVE (generate.mjs), не здесь: потеряв их при
